...
## Android
To use this framework on a local machine for Android, emulator(s) need to be available.
...
- From Android Studio itself through:
    ...
    ![Start Android AVD Manager](./assets/start-android-avd-manager.jpeg)
    
    - Select your emulator and click on the `play`-button
    
    ![Select emulator](./assets/select-avd.jpeg)
...
1. Go to Xcode preferences like below
    ...
    ![Xcode preferences](./assets/xcode-preferences.jpeg)
    
1. A pop-up will appear like below

    ![Xcode preferences pop-up](./assets/xcode-preferences-popup.jpeg)
    
1. Go to `Components` and download the needed versions like below 

    ![Xcode components](./assets/xcode-components.jpeg)
...
- Through the Simulator app, find it on Mac and add it to your dock like below
    ...
    ![Simulator App](./assets/simualtor-app.jpeg)

    ![Simulator start](./assets/start-simulator.jpeg)
